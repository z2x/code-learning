...
window.onload = function() {
    ...
    if (drawing.getContext) {
        ...
        context.fillText("12", 0, 20);
        context.fillText("9", 20, 0);
...
function shadowing() {
    var shadowing = document.getElementById("shadowing");

    //make sure <canvas> is completely supported
    if (shadowing.getContext) {

        var context = shadowing.getContext("2d");
        ...
        // 配置渐变颜色
        var gradient = createRectLinearGradient(context, 30, 30, 250, 190);
        gradient.addColorStop(0, "white");
        gradient.addColorStop(1, "black");

        //draw a gradient rectangle
        context.fillStyle = gradient;
        context.fillRect(30, 30, 250, 190);
    }
}
shadowing();
...
function radialGradient() {
    ...
    if (shadowing.getContext) {
        var context = shadowing.getContext("2d");
        var gradient = context.createRadialGradient(480, 480, 0, 480, 480, 100);
        gradient.addColorStop(0, "white");
        gradient.addColorStop(1,"black");

        context.fillStyle = "red";
        context.fillRect(340, 340, 200, 200);

        context.fillStyle = gradient;
        context.fillRect(380, 380, 200, 200);
    }
}
radialGradient();
